...
def filtered_search(query: str, filter_expr: str, top_k: int = 5):
    ...
    for hits in results:
        ...
        for rank, hit in enumerate(hits, start=1):
            ...
            print(f"Created Date: {entity['created_date']}")
...
if __name__ == "__main__":
    filtered_search(
        query="recharge failed but voucher was valid",
        filter_expr='domain == "telecom"',
    )
